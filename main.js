...
mobile: MethodMobile, 
browser: opcion == '1' ? ['itachi-Bot-MD', 'Safari', '2.0.0'] : methodCodeQR ? ['itachixov-Bot-MD', 'Safari', '2.0.0'] : ['Ubuntu', 'Chrome', '110.0.5585.95'],
auth: {
creds: state.creds,
...
setInterval(async () => {
  ...
  const bio = `[ 🛡️ ] ASTA BOT MD: ${uptime}`;
