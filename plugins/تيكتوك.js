...
const handler = async (m, {conn, text, args, usedPrefix, command}) => {
  if (!text) throw `_*< تحميل - تيك توك />*_\n\n*[ ❗ ] أدخل رابط تيك توك.*\n\n*مثل:* _${usedPrefix + command} https://vm.tiktok.com/ZM686Q4ER/_`;
  if (!/(?:https:?\/{2})?(?:w{3}|vm|vt|t)?\.?tiktok.com\/([^\s&]+)/gi.test(text)) throw `_*< التنزيلات - تيكتوك />*_\n\n*[ ❗ ] أدخل رابط تيك توك.*\n\n*مثل:* _${usedPrefix + command} https://vm.tiktok.com/ZM686Q4ER/_`;
  const texto = `*يتم إرسال الفيديو انتظر . . .*`;
  ...
  try {
    ...
    const desc1n = `_*< التنزيلات - تيكتوك />*_\n\n*[ ❗ ] الرد على هذا الفيديو مع الأمر* _${usedPrefix}tomp3_ *لتحويله إلى صوت.*`;
    ...
    try {
      ...
      try {
        ...
        try {
          ...
          const cap = `_*< التنزيلات - تيكتوك />*_\n\n*[ ❗ ] الرد على هذا الفيديو مع الأمر* _${usedPrefix}tomp3_ *لتحويله إلى صوت.*`;
          await conn.sendMessage(m.chat, {video: {url: url}, caption: cap}, {quoted: m});
        } catch {
          throw `_*< التنزيلات - تيكتوك />*_\n\n*[ 🚩 ] حدث خطأ.  الرجاء معاودة المحاولة في وقت لاحق.*`;
          }
        }
      }
    }
...
handler.command = /^(tiktok|ttdl|tiktokdl|tiktoknowm|tt|ttnowm|tiktokaudio|تيك|تيكتوك)$/i;
export default handler;

async function tiktokdlF(url) {
  if (!/tiktok/.test(url)) return `_*< التنزيلات - تيكتوك />*_\n\n*[ ❗ ] أدخل رابط تيك توك.*\n\n*مثل:* _${usedPrefix + command} https://vm.tiktok.com/ZM686Q4ER/_`;
